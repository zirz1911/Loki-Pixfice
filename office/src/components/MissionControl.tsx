...
const SPRS: Record<string, string[]> = {
  ...
  huginn:       ['0HHHHHH0','HHAHHHH0','0SSSSSS0','0AEPPSS0','0SSSSSS0','0SSMSSS0','0CCCCCC0','CCAACCCC','CAHACCCC','0CCCCCC0','0LL00LL0','0BB00BB0'],
  freyr:        ['0AAAAAA0','0HHHHHH0','H0SSSSSH','0SEPPSS0','0SSSSSS0','0SWMSSS0','0CCCCCC0','CAACCACC','CCAACCCC','0CCCCCC0','0LL00LL0','0BB00BB0'],
  'loki-gemini':['0AAAAAA0','0HHHHHH0','0SSSSSS0','0AEPPAS0','0SSSSSS0','0SSMSSS0','0CCCCCC0','CAACCACC','CCAACCCC','0ACCCCA0','0LL00LL0','0BB00BB0'],
...
function SvgAgentCircle({
  ...
  const pk = Object.keys(PALS).find(k => k !== "default" && k === key)
    ?? Object.keys(PALS).find(k => k !== "default" && key.startsWith(k))
    ?? "default";
  const pal = PALS[pk];
