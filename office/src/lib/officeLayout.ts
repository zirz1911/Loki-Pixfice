...
export const ITEM_W: Record<FurnitureType, number> = {
  desk: 40, plant: 14, lamp: 10, bookshelf: 32,
};
export const ITEM_H: Record<FurnitureType, number> = {
  desk: 32, plant: 18, lamp: 28, bookshelf: 22,
};
...
// ── Persistence ───────────────────────────────────────────────────────────────
const KEY = 'loki-pixfice-layout-v2';
